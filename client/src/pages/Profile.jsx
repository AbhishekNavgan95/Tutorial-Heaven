...
const Profile = () => {
    ...
    return (
        <div className=' lg:w-8/12 mx-auto py-10 self-center'>
            <div className='flex flex-col xl:flex-row justify-start items-center md:items-start xl:items-center gap-10'>
                <span className='w-max flex justify-center'><img src={user?.image?.url} className='max-w-[150px] object-cover aspect-square rounded-full border-4 border-blue-300 ' alt="" /></span>
