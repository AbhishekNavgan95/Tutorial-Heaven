    ...
    return (
        <div className='w-8/12 mx-auto py-10'>
            <div className='flex flex-row-reverse justify-between gap-10'>
                <span className=''><img src={user?.image?.url} className='max-w-[150px] aspect-square rounded-full border-4 border-blue-300 ' alt="" /></span>
                <span className='grid grid-cols-[auto,1fr] gap-x-10 gap-y-10'>
