    ...
    return (
        <div className='lg:w-8/12 mx-auto self-center'>
            <div className='flex flex-col xl:flex-row justify-start items-center md:items-start xl:items-center gap-y-5 md:gap-y-10 gap-x-10'>
                <span className='w-max flex justify-center'><img src={user?.image?.url} loading='lazy' className='max-w-[120px] min-w-[120px] md:max-w-[150px] object-cover aspect-square rounded-full border-4 border-blue-300 ' alt="" /></span>
