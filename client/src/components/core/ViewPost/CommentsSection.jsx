        ...
        <div className='pb-5 w-full '>
            <div className='bg-night-5 w-full lg:sticky top-[4rem] pt-5 border-b border-night-50'>
                ...
                <form onSubmit={handleSubmit(submitHandler)} className='pt-3 w-full flex flex-col items-end gap-3 pb-3'>
                    <textarea {...register("comment", { required: true })} placeholder='Add a commment...' rows={2} type="text" className='w-full py-2 text-sm sm:text-base lg:text-lg resize-none bg-night-5 outline-none  border-b border-night-700'></textarea>
