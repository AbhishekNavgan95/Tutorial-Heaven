...
const Button = ({ children, type, active, action, styles, disabled }) => {
    return (
        <button
            ...
            w-full px-4 text-nowrap transition-all hAover:shadow-night-600 hover:shadow-md shadow-sm shadow-night-300 duration-300  py-2 active:scale-[0.95] rounded-lg ${styles}
        `}
        >
            {children}
        </button>
